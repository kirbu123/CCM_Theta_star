...
if(isaac_utils_CONFIG_INCLUDED)
  return()
endif()
set(isaac_utils_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(isaac_utils_SOURCE_PREFIX /home/vitaly/rtabmap_helper_ws/src/isaac_utils)
  set(isaac_utils_DEVEL_PREFIX /home/vitaly/rtabmap_helper_ws/devel)
  set(isaac_utils_INSTALL_PREFIX "")
  set(isaac_utils_PREFIX ${isaac_utils_DEVEL_PREFIX})
else()
  set(isaac_utils_SOURCE_PREFIX "")
  set(isaac_utils_DEVEL_PREFIX "")
  set(isaac_utils_INSTALL_PREFIX /home/vitaly/rtabmap_helper_ws/install)
  set(isaac_utils_PREFIX ${isaac_utils_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'isaac_utils' is deprecated")
...
set(isaac_utils_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(isaac_utils_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${isaac_utils_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'isaac_utils' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'isaac_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vitaly/rtabmap_helper_ws/src/isaac_utils/${idir}'.  ${_report}")
    endif()
    _list_append_unique(isaac_utils_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND isaac_utils_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND isaac_utils_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT isaac_utils_NUM_DUMMY_TARGETS)
      set(isaac_utils_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::isaac_utils::wrapped-linker-option${isaac_utils_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR isaac_utils_NUM_DUMMY_TARGETS "${isaac_utils_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::isaac_utils::wrapped-linker-option${isaac_utils_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND isaac_utils_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(isaac_utils_LIBRARY_DIRS ${lib_path})
      list(APPEND isaac_utils_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'isaac_utils'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND isaac_utils_LIBRARIES ${lib})
    endif()
  endif()
...
set(isaac_utils_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${isaac_utils_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 isaac_utils_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${isaac_utils_dep}_FOUND)
      find_package(${isaac_utils_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${isaac_utils_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(isaac_utils_INCLUDE_DIRS ${${isaac_utils_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(isaac_utils_LIBRARIES ${isaac_utils_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${isaac_utils_dep}_LIBRARIES})
  _list_append_deduplicate(isaac_utils_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(isaac_utils_LIBRARIES ${isaac_utils_LIBRARIES})

  _list_append_unique(isaac_utils_LIBRARY_DIRS ${${isaac_utils_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(isaac_utils_EXPORTED_TARGETS ${${isaac_utils_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${isaac_utils_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
