...
if(rtabmap_help_CONFIG_INCLUDED)
  return()
endif()
set(rtabmap_help_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(rtabmap_help_SOURCE_PREFIX /home/vitaly/rtabmap_helper_ws/src/rtabmap_help)
  set(rtabmap_help_DEVEL_PREFIX /home/vitaly/rtabmap_helper_ws/devel)
  set(rtabmap_help_INSTALL_PREFIX "")
  set(rtabmap_help_PREFIX ${rtabmap_help_DEVEL_PREFIX})
else()
  set(rtabmap_help_SOURCE_PREFIX "")
  set(rtabmap_help_DEVEL_PREFIX "")
  set(rtabmap_help_INSTALL_PREFIX /home/vitaly/rtabmap_helper_ws/install)
  set(rtabmap_help_PREFIX ${rtabmap_help_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'rtabmap_help' is deprecated")
...
set(rtabmap_help_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(rtabmap_help_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'vitaly <vitaly@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${rtabmap_help_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rtabmap_help' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rtabmap_help' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vitaly/rtabmap_helper_ws/src/rtabmap_help/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rtabmap_help_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND rtabmap_help_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND rtabmap_help_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT rtabmap_help_NUM_DUMMY_TARGETS)
      set(rtabmap_help_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rtabmap_help::wrapped-linker-option${rtabmap_help_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rtabmap_help_NUM_DUMMY_TARGETS "${rtabmap_help_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rtabmap_help::wrapped-linker-option${rtabmap_help_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rtabmap_help_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(rtabmap_help_LIBRARY_DIRS ${lib_path})
      list(APPEND rtabmap_help_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'rtabmap_help'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND rtabmap_help_LIBRARIES ${lib})
    endif()
  endif()
...
set(rtabmap_help_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${rtabmap_help_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 rtabmap_help_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${rtabmap_help_dep}_FOUND)
      find_package(${rtabmap_help_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rtabmap_help_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(rtabmap_help_INCLUDE_DIRS ${${rtabmap_help_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(rtabmap_help_LIBRARIES ${rtabmap_help_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${rtabmap_help_dep}_LIBRARIES})
  _list_append_deduplicate(rtabmap_help_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(rtabmap_help_LIBRARIES ${rtabmap_help_LIBRARIES})

  _list_append_unique(rtabmap_help_LIBRARY_DIRS ${${rtabmap_help_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(rtabmap_help_EXPORTED_TARGETS ${${rtabmap_help_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${rtabmap_help_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
