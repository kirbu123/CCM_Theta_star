...
if(theta_star_planner_CONFIG_INCLUDED)
  return()
endif()
set(theta_star_planner_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(theta_star_planner_SOURCE_PREFIX /home/vitaly/theta_star_ws/src/ThetaStarROS)
  set(theta_star_planner_DEVEL_PREFIX /home/vitaly/theta_star_ws/devel)
  set(theta_star_planner_INSTALL_PREFIX "")
  set(theta_star_planner_PREFIX ${theta_star_planner_DEVEL_PREFIX})
else()
  set(theta_star_planner_SOURCE_PREFIX "")
  set(theta_star_planner_DEVEL_PREFIX "")
  set(theta_star_planner_INSTALL_PREFIX /home/vitaly/theta_star_ws/install)
  set(theta_star_planner_PREFIX ${theta_star_planner_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'theta_star_planner' is deprecated")
...
set(theta_star_planner_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/vitaly/theta_star_ws/src/ThetaStarROS/include " STREQUAL " ")
  set(theta_star_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/vitaly/theta_star_ws/src/ThetaStarROS/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'blackbox <blackbox@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${theta_star_planner_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'theta_star_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'theta_star_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vitaly/theta_star_ws/src/ThetaStarROS/${idir}'.  ${_report}")
    endif()
    _list_append_unique(theta_star_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND theta_star_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND theta_star_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT theta_star_planner_NUM_DUMMY_TARGETS)
      set(theta_star_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::theta_star_planner::wrapped-linker-option${theta_star_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR theta_star_planner_NUM_DUMMY_TARGETS "${theta_star_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::theta_star_planner::wrapped-linker-option${theta_star_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND theta_star_planner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(theta_star_planner_LIBRARY_DIRS ${lib_path})
      list(APPEND theta_star_planner_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'theta_star_planner'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND theta_star_planner_LIBRARIES ${lib})
    endif()
  endif()
...
set(theta_star_planner_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${theta_star_planner_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 theta_star_planner_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${theta_star_planner_dep}_FOUND)
      find_package(${theta_star_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${theta_star_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(theta_star_planner_INCLUDE_DIRS ${${theta_star_planner_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(theta_star_planner_LIBRARIES ${theta_star_planner_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${theta_star_planner_dep}_LIBRARIES})
  _list_append_deduplicate(theta_star_planner_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(theta_star_planner_LIBRARIES ${theta_star_planner_LIBRARIES})

  _list_append_unique(theta_star_planner_LIBRARY_DIRS ${${theta_star_planner_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(theta_star_planner_EXPORTED_TARGETS ${${theta_star_planner_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${theta_star_planner_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
