...
- [virtual-husky](#virtual-husky)
  ...
  - [Usage patterns](#usage-patterns)
    ...
    - [Pre-setted cases](#pre-setted-cases)
      - [Offline demo with sensors and ROS1/2 publishing in MIPT env](#offline-demo-with-sensors-and-ros12-publishing-in-mipt-env)
      - [Online demo with sensors and ROS1 publishing in MIPT env](#online-demo-with-sensors-and-ros1-publishing-in-mipt-env)
